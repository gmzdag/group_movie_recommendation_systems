...
- Hybrid 2: w_ubcf=0.20, w_cbf=0.80, Aggregation=Least Misery
...
def main():
    ...
    h2_lm_eval = Hybrid2TestEvaluator(train_df, test_df, movies_df, w_ubcf=0.20, w_cbf=0.80, aggregation='least_misery')
    h2_lm_scores = []
    ...
    print(f"Hybrid 2 (w=0.20/0.80, Least Misery):   NDCG@10 = {h2_lm_avg:.4f}")
    ...
    results = pd.DataFrame([
        ...
        {'Model': 'Hybrid 2', 'Config': 'w=0.20/0.80, Least Misery', 'Test_NDCG@10': h2_lm_avg, 'Num_Groups': len(h2_lm_scores)}
    ])
