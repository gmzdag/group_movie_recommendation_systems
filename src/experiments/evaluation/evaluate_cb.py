...
if __name__ == "__main__":
    ...
    # We use ONLY train_df to build user profiles to ensure no data leakage.
    ...
    # Save results
    res_path = os.path.join(RESULTS_DIR, "cb_experiment_results.txt")
    ...
    plot_path = os.path.join(RESULTS_DIR, "cb_error_dist.png")
